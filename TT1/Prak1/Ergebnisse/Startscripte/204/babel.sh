...
ifconfig wlan0 up
ifconfig wlan0 10.0.0.204 netmask 255.255.255.0 # XYZ=AP-Nummer
...
iptables -t nat -A POSTROUTING -s 192.168.204.0/24 -j MASQUERADE
route add default gw 10.0.0.201
babeld -C 'redistribute metric 256' -D wlan0 eth0
